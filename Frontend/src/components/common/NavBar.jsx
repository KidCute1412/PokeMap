        ...
        <div className="flex items-center" onClick = {() => navigate("/profile")}>
            {isSignedIn ? (
                <>
                    ...
                    <img src={profileImage} alt="Profile" className="w-10 h-10 ml-2 rounded-full cursor-pointer hover:ring-2 hover:ring-blue-500" />
...
function BellNotification({children}){
